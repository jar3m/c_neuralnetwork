...
##
# 1 hidden layer 13 nodes(sig)
# learning rate 0.1
# input scaled putput unscaled
##
...
time ./all examples/bc_diag/bc_config > $log_file
...
#gnuplot -persist -e " plot './profile/some' using 2, './profile/some' using 3"
